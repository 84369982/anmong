package com.anmong.common.fastsql;
...
import com.anmong.common.fastsql.dto.ColumnMetaData;
import com.anmong.common.fastsql.dto.ResultPage;
import com.anmong.common.fastsql.mapper.OraclePagingSingleColumnRowMapper;
import com.anmong.common.fastsql.util.FastSqlUtils;
import com.anmong.common.fastsql.util.PageTemplate;
import com.anmong.common.fastsql.util.PageUtils;
...
public class SQL {
    ...
    public SQL ifPresentAND(String condition, Object object) {
        if (object == null || "".equals(object)) {
            return this;
        } else {
            String like = String.valueOf(object).replace("%","");
            if (!StringUtils.isEmpty(like) ){
                strBuilder.append(" AND ").append(condition + getStringByType(object));
            }
            return this;
        }
    }

    public SQL ifTrueAND(String condition, boolean b) {
        if (b) {
    ...
    public SQL ifTrueAND(String condition,Object object, boolean b) {
        if (b) {
            if (object == null || "".equals(object)) {
                strBuilder.append(" AND ").append(condition);
            }
