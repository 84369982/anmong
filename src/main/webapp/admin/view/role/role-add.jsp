  ...
  <form class="form form-horizontal" id="form-admin-add">
	 ...
	 <div class="row cl">
	  ...
	  <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入角色编码" id="code" name="code">
			</div>
	  </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="note" cols="" rows="" class="textarea"  placeholder="角色备注...500个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,500)"></textarea>
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){;
			$(form).ajaxSubmit({
				type: 'post',
				url: "${pageContext.request.contextPath}/web/role/add" ,
