  ...
  <form class="form form-horizontal" id="form-admin-add">
	  ...
	  <div class="row cl">
	    ...
	    <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" placeholder="请输入6-16位密码，只能为字母或数字" id="oldPassword" name="oldPassword">
			</div>
	  </div>
	   ...
	   <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" placeholder="请输入6-16位密码，只能为字母或数字" id="newPassword" name="newPassword">
			</div>
	  </div>
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){;
			$(form).ajaxSubmit({
				type: 'post',
				url: "${pageContext.request.contextPath}/web/user/change-password" ,
